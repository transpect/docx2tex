...
<p:declare-step 
  ...
  <tr:xslt-mode msg="yes" hub-version="1.1" mode="docx2tex-preprocess" name="docx2tex-preprocess">
    <p:input port="stylesheet">
      <p:pipe port="stylesheet" step="docx2tex-evolve-hub"/>
    </p:input>
    <p:input port="models"><p:empty/></p:input>
    ...
    <p:with-option name="debug" select="$debug"/>
    <p:with-option name="debug-dir-uri" select="$debug-dir-uri"/>
    <p:with-option name="prefix" select="'evolve-hub/06'"/>
  </tr:xslt-mode>
  
  <tr:xslt-mode msg="yes" hub-version="1.1" mode="docx2tex-postprocess" name="docx2tex-postprocess">
    <p:input port="stylesheet">
      <p:pipe port="stylesheet" step="docx2tex-evolve-hub"/>
    </p:input>
    <p:input port="models"><p:empty/></p:input>
    ...
    <p:with-option name="debug" select="$debug"/>
    <p:with-option name="debug-dir-uri" select="$debug-dir-uri"/>
    <p:with-option name="prefix" select="'evolve-hub/07'"/>
  </tr:xslt-mode>
